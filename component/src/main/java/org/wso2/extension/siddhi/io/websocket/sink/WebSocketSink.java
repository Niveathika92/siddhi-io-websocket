...
@Extension(
        ...
        parameters = {
                ...
                @Parameter(
                        ...
                        description = "The file path to the location of the truststore. If a custom truststore is not " +
                                "specified, then the system uses the default truststore file - wso2carbon.jks in the " +
    ...
    protected void init(StreamDefinition streamDefinition, OptionHolder optionHolder,
        ...
        try {
            ...
            if (Objects.equals("wss", scheme)) {
                ...
                this.tlsstruststorePath = optionHolder.validateAndGetStaticValue(WebSocketProperties.TLS_TRUSTSTORE_PATH,
                        configReader.readConfig
                                (WebSocketProperties.TLS_TRUSTSTORE_PATH,
                                        WebSocketProperties
                                                .DEFAULT_TRUSTSTORE_FILE_PATH));
                this.tlsstruststorePass = optionHolder.validateAndGetStaticValue(WebSocketProperties.TLS_TRUSTSTORE_PASS,
                        configReader.readConfig(
